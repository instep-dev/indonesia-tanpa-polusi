  ...
  <section id="about" className="bg-background px-6 py-16 sm:px-10 lg:px-20">
    <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-3 lg:items-start">
      ...
      <div className="lg:col-span-2">
        <span className="text-sm font-extrabold text-foreground/60 uppercase">{dict.label}</span>
        <h2 className="mt-2 text-3xl font-tilt-warp leading-tight text-brand-navy dark:text-foreground sm:text-4xl">
          {dict.title}
        </h2>
