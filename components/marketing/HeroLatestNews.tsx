...
const HeroLatestNews = ({ dict }: HeroLatestNewsProps) => (
  <section className="relative w-full">
    <div className="relative h-[520px] w-full overflow-hidden bg-neutral-500 sm:h-[600px] lg:h-[680px]" style={{ backgroundImage: 'url(https://images.unsplash.com/photo-1586733023383-9f9a59509453?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)', backgroundSize: 'cover', backgroundPosition: "center", }}>
